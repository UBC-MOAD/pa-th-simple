"""CCAR-Modeling IPython Notebook collection README generator
...
repo = 'bitbucket.org/ccar-modeling/pa-th/raw/tip'
repo_dir = 'prelim-model'
url = os.path.join(nbviewer, repo, repo_dir)
title_pattern = re.compile('#{1,6} ?')
readme = """The IPython Notebooks in this directory are related to the
